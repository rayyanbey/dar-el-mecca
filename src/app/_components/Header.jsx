...
export function Header() {
  ...
  return (
    <div className="sticky top-0 z-50 bg-white">
      ...
      {/* For Desktop */}
      <nav
        className={`w-full px-20 hidden lg:flex py-1 justify-between items-center bg-white transition-shadow duration-300 ${
      ...
      >
        ...
        <div className="flex gap-6 pl-12 items-center font-[300] text-[16px]">
          ...
          {/* Umrah Packages - Changed from p to div */}
          <div
          ...
          {/* Tour Packages - Changed from p to div */}
          <div
