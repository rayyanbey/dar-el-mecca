    ...
    return (
        <div className="flex flex-col gap-4 w-full  lg:w-[24rem] rounded-t-full border-[1px] border-[#00000014] p-6 bg-transparent transition-colors duration-500 hover:bg-[#f6f2ed]">
            ...
            <div className="flex justify-between">
                <h3 className="font-[700] cinzel-title text-[20px]">February Umrah</h3>
            ...
            <div className="flex justify-between items-center">
                <div className="flex flex-col">
                    ...
                    <p className="font-[700] cinzel-title text-[#6F634E]  text-[23.3px]">$2400</p>
                </div>
                <BrownButton text="Book Now" />
            </div>
        </div>
    );
}
