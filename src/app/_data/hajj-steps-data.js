const hajjSteps = [
    ...
    },
    {
        ...
        description: [
            ...
            , "“The Prophet (peace and blessings be upon him) offered the Maghrib and ‘Isha prayers together at Muzdalifah with a separate Iqamah (second call to prayer) for each of them and did not offer any optional prayer in between them or after each of them.” [Bukhari]"
            ,
    ...
    },
    {
        ...
        description: [
            ...
            ,
            "Origin Of Rami (The Stoning Of The Devil) The stoning of the Jamarat – otherwise referred to as the ‘stoning of the devil’ – is a ritual carried out by Hajj pilgrims whereby pebbles are thrown at three stone structures in Mina across three days."
            ,
            ...
            "How To Perform The Rami (The Stoning Of The Devil) On the 10th, 11th, and 12th day of Dhul Hijjah, you will perform Rami (the stoning of the devil). The size of the pebbles should be similar to the size of date stones or seeds. You will need a total of 49 pebbles.",
    ...
    },
    {
        ...
        description: [
            ...
            , "This Tawaf is Wajib (obligatory) according to Hanafis, Shafi’is and Hanbalis but Sunnah according to Malikis and must be performed before leaving the Haram's boundaries. Omitting this Tawaf, without a valid reason, is not deemed lawful in Islam."
            ,
